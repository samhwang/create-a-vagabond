...
export const vagabondCreateInputAtom = atom<Input>((get) => {
...
export const resetVagabondCreateInputAtom = atom(null, (get, set, _update) => {
...
export function ClassStep() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Stack spacing={2}>
        <RHFTextField control={control} name="class" label="Class" />
...
export function StatsStep() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Stack spacing={2}>
        <RHFQuantityField control={control} name="charm" label="Charm" />
        <Stack direction="row" justifyContent="flex-end">
  ...
  return (
    <Stack spacing={2}>
      ...
      <Stack direction="row" justifyContent="flex-end">
        ...
        <Button onClick={() => navigate('/vagabond-create/stats')}>Back</Button>
        <Button type="submit" variant="contained">
          Create
        </Button>
      </Stack>
...
function useSyncDefaultInput(input: any, onValue: (key: any, value: any) => void) {
  useEffect(() => {
