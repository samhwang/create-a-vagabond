...
export const useStartingPointLeft = (vagabondClassRef?: useStartingPointLeft_class$key | null) => {
  ...
  return startingPoint
    - charm + (vagabondClass.startingCharm || 0)
    - cunning + (vagabondClass.startingCunning || 0)
    - finesse + (vagabondClass.startingFinesse || 0)
    - luck + (vagabondClass.startingLuck || 0)
    - might + (vagabondClass.startingMight || 0)
}
