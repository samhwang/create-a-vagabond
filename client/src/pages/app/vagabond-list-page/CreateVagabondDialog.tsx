...
export function CreateVagabondDialog({ connectionIds, open, onClose }: CreateVagabondDialogProps) {
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <DialogContent>
          <RHFTextField control={control} name="name" label="Vagabond Name" disabled={isOnFly} sx={{ mt: 1 }} />
        </DialogContent>
        <DialogActions>
