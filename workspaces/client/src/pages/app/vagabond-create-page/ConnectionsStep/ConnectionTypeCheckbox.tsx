...
type ConnectionTypeCheckboxFieldProps<T extends FieldValues> = RHFCheckboxFieldProps<T> & {
  ItemProps?: Omit<RHFCheckboxFieldItemProps<T>, 'control' | 'name' | 'label' | 'value' | 'helperText'>;
};

export function ConnectionTypeCheckboxField<T extends FieldValues>({
  ItemProps = {},
  ...props
